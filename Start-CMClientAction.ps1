...
Function Start-CMClientAction
{
    <#  
      ...
      .PARAMETER SCCMClientAction
          ...
          Enter a numerical value from 1-49 that represents each SCCM client action listed in the Notes section under the "SCCM Client Action Trigger Codes" heading.

      .PARAMETER SCCMActionsBundle

          A switch parameter that does not accept any values, but rather tells the function to run the following 3 actions listed in the Notes section under the "SCCM Client Action Trigger Codes" heading:
      ...
      .EXAMPLE
       ...
       .EXAMPLE
          ...
          Initiate an SCCM Client Action Bundle on the Local Computer that Runs Options 7, 38, and 33 (Machine Policy Retrieval & Evaluation Cycle, Software Updates Scan Cycle, and Software Updates Deployment Evaluation Cycle)

          Start-CMClientAction -SCCMActionsBundle

       .EXAMPLE

          Initiate an SCCM Client Action Bundle on a Remote Computer that Runs Options 7, 38, and 33 (Machine Policy Retrieval & Evaluation Cycle, Software Updates Scan Cycle, and Software Updates Deployment Evaluation Cycle)

          Start-CMClientAction -ComputerName 'RemoteComputer1' -SCCMActionsBundle

       .EXAMPLE

          Initiate an SCCM Client Action Bundle on Multiple Remote Computers that Runs Options 7, 38, and 33 (Machine Policy Retrieval & Evaluation Cycle, Software Updates Scan Cycle, and Software Updates Deployment Evaluation Cycle)
