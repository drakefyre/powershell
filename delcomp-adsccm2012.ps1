...
param (
	...
	[parameter(Mandatory=$false, HelpMessage="Enter SCCM server")][string]$sccmServer='CINSCCM12.dinslaw.com',
	[parameter(Mandatory=$false, HelpMessage="Enter SCCM server")][string]$sccmSite='CIN'
)
